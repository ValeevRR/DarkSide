...
from sithWay.views import SithListView, SithListMoreThanOne
...
urlpatterns = [
    ...
    path('siths/all', SithListView.as_view(), name="sith_list"),
    path('siths/filtered/1', SithListMoreThanOne.as_view(), name="sith_list_filtered"),
